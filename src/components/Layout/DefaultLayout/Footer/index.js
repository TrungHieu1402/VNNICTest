...
import {faLocationPin, faSquarePhone} from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <div className="w-screen relative bottom-0 right-0 left-0 bg-[#133c8b] lg:flex lg:justify-center">
            <div className="py-[15px] lg:w-4/5 w-full lg:flex ">
                <img className="mb-1 lg:mb-0 pl-6 lg:pl-0" src="https://2022.vnix-nog.vn/sites/default/files/vnnic-logo.png"/>
                <div className="lg:flex justify-between pl-6">
                    <div className="">
                        <p className="uppercase text-white font-bold pb-4">Bộ thông tin và truyển thông</p>
                        <p className="uppercase text-white font-bold">Trung tâm internet Việt Nam</p>
                    </div>
